...
APPS_URL = "https://pandorarevolution.com"
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False, with_demo=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the Pandora Studio app."))
    ...
    def _get_missing_dependencies(self, zip_data):
        ...
        if unavailable_modules:
            ...
            description += _(
                ...
                "https://www.pandorarevolution.com"
                "If you need Website themes, it can be downloaded from https://pandorarevolution.com .\n"
            )
        elif modules:
